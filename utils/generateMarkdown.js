...
function generateMarkdown(data) {
  ...
  for (sections of data.contents){
    switch (sections) {
      case 'screenshot':
        sectionsText = `\r\n### Screenshot\r![Demo screenshot 1](${data.imageSrc})\r`;
        break;
      case 'contents':
        ...
        break;
      case 'installation':
        sectionsText = `\r\n## ${sections.capitalize()}\n\r${data.install}  \rApplication can be accessed at [${data.website}](${data.website})\r`;
        break;
      case 'usage':
        sectionsText = `\r\n## ${sections.capitalize()}\n\r${data.usage}  \rAll app code is available at repository [${data.repo}](${data.repo})\r`;
        break;
      case 'license':
